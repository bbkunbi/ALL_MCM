...
int command_process_IFLO(parseCMSCmd *Wrpr_Cmd, devResponse *MCM_Resp)
{
  int arg_fpscnt=0;
  int i, j ;
  char *fevar[] =  { "ilo_ch1","ilo_ch2","ifbw_ch1" ,"ifbw_ch2" ,"pre_attn_ch1","pre_attn_ch2","post_gain_ch1" ,"post_gain_ch2" ,"ifalc_ch1" ,"ifalc_ch2","ofcatten_ch1","ofcatten_ch2"};
  typedef enum { ILO_CH1,ILO_CH2,IFBW_CH1,IFBW_CH2, PRE_ATTN_CH1,PRE_ATTN_CH2,POST_GAIN_CH1,POST_GAIN_CH2,IFALC_CH1,IFALC_CH2,OFCATTEN_CH1,OFCATTEN_CH2,TSET};
