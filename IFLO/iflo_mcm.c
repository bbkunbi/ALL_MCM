...
//#define DEBUG
//#define JDEBUG
int MCMCARD1 = 2, MCMCARD2 = 3, MCMCARD3=10,MCMCARD4=0;
...
int ifloCtrlCmd(parseCMSCmd *Wrpr_Cmd)
{
   ...
   typedef enum { SETLO=0, SETIF=1, OFCATTN=2,DOMON=3,SRVRST=4,FPSRST=5,SETSIGCON=6,SETIFATTN=7, TCMD=8 } IFLOEnum;
     resp_msg_cntr = 0 ;
